...
titleHolder.append(titleLabel, titleInput);
...
authorHolder.id = "author-holder";
authorHolder.append(authorLabel, authorInput);
...
descriptionHolder.id = "description-holder";
...
pagesHolder.append(pagesLabel, pagesInput);
...
addButton.addEventListener("click", () => {
  bookForm.appendChild(titleHolder);
  bookForm.appendChild(authorHolder);
  bookForm.appendChild(descriptionHolder);
  bookForm.appendChild(pagesHolder);
